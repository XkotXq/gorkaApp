...
export default function editPost() {
	...
	const sendPostForm = () => {
		...
		formData.append("id", updatedPost._id);
		...
		axios
			.post(`${apiUrl}/api/admin/post/edit`, formData, {
				headers: {
			...
			<View className="flex flex-row items-center p-2">
				...
				<View className="flex flex-col">
					<Text
						...
						{updatedPost.authorName ? updatedPost.authorName : "Brak"}
					</Text>
					<Text
						style={{ color: colors.text }}
						className="pl-2 pb-0 font-GilroyMedium">
						{updatedPost.authorNick ? updatedPost.authorNick : "Brak"}
					</Text>
